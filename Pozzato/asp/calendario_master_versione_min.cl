...
%prima lezione
prima_settimana(S,I):-lezione(S,_,_,I), S == #min{S2:lezione(S2,_,_,I)}.
primo_giorno(S,G,I):-lezione(S,G,_,I),numero_giorno(G,X2), X2 == #min{X : numero_giorno(G,X),prima_settimana(S,I),lezione(S,G,_,I)}.
prima_lezione(S,G,O,I):-lezione(S,G,O,I), O == #min{O2: primo_giorno(S,G,I),lezione(S,G,O2,I)}.

%ultima_lezione
ultima_settimana(S,I):-lezione(S,_,_,I), S == #max{S2:lezione(S2,_,_,I)}.
ultimo_giorno(S,G,I):-lezione(S,G,_,I),numero_giorno(G,X2), X2 == #max{X : numero_giorno(G,X),ultima_settimana(S,I),lezione(S,G,_,I)}.
ultima_lezione(S,G,O,I):-lezione(S,G,O,I), O == #max{O2: ultimo_giorno(S,G,I),lezione(S,G,O2,I)}.
...
#show lezione/4.
#show prima_settimana/2.
#show primo_giorno/3.
#show prima_lezione/4.

#show ultima_settimana/2.
#show ultimo_giorno/3.
#show ultima_lezione/4.
