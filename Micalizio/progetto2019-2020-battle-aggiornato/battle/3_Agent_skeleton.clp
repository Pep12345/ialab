; DESCRIZIONE: questa classe contiene le regole fondamentali a cui poi aggiungeremo quelle dell'euristica
; bisogna aggiungere fire e guess finali in base all'euristica da provare
;  ---------------------------------------------
