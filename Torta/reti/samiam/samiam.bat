...
REM set VMARGS=-Xruncalljvmti -Xms8m -Xmx512m -classpath samiam.jar;inflib.jar edu.ucla.belief.ui.UI
set VMARGS=-Xms8m -Xmx512m -classpath samiam.jar;inflib.jar edu.ucla.belief.ui.UI
